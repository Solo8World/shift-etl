...
接口数据结构示例：  
<img src="https://s1.ax1x.com/2020/10/10/0szB8O.png" width="80%">

#### 三步实现

1. 将接口信息录入etl_source表  
<img src="https://s1.ax1x.com/2020/10/10/0yCnQU.png" width="80%">  
...
<img src="https://s1.ax1x.com/2020/10/10/0yENlt.png" width="80%">    
...
demo表嗷嗷待哺了同志们  
<img src="https://s1.ax1x.com/2020/10/10/0yDp5D.png" width="80%">    
...
ok继续  
有了：  
<img src="https://s1.ax1x.com/2020/10/10/0yRfKg.png" width="80%">    
(看来大家都有一个发财梦)

与此同时我们的`etl_source_data`表中也多了一条数据，嗯是两条：
<img src="https://s1.ax1x.com/2020/10/10/0yWgoR.png" width="80%">    
